...
class SWMainViewController: UITabBarController {
    ...
    func addChildViewControllers() {
        let first = SWMainVCStruct.init(title: "First", imgName: "me", vc: FirstViewController())
        let second = SWMainVCStruct.init(title: "Second", imgName: "me", vc: SWMapVC())
        let third = SWMainVCStruct.init(title: "Third", imgName: "me", vc: SWMapVC())
